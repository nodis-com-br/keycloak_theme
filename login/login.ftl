        ...
        <#if realm.password>
            <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                <div class="${properties.kcFormGroupClass!}">
                    ...
                    <div class="icon-container icon-container--login">
                      <#if usernameEditDisabled??>
                          <input tabindex="1" id="username" class="${properties.kcInputClass!}" placeholder="<#if !realm.loginWithEmailAllowed>${msg('username')}<#elseif !realm.registrationEmailAsUsername>${msg('usernameOrEmail')}<#else>${msg('email')}</#if>" name="username" value="${(login.username!'')}" type="text" disabled />
                      <#else>
                ...
                <div class="${properties.kcFormGroupClass!}">
                    ...
                    <div class="icon-container icon-container--password">
